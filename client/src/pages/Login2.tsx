    ...
    fetch(`/api/empresa-por-slug/${slugEmpresa}`, { headers: { 'x-empresa-slug': slugEmpresa } })
      ...
      .then((j) => {
        ...
        setConfig({
          ...
          nome: empresa.nome || '',
          marca: empresa.marca || 'OLIVER ERP',
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-slate-100">
      <div className="grid min-h-screen lg:grid-cols-2">
        <section
          className="relative hidden overflow-hidden bg-[#080808] text-white lg:flex"
          style={{
            backgroundImage: `url('${config.fundoLogin || '/oliver-erp-login.png'}')`,
            ...
            <div>
              ...
              <div className="mt-7 max-w-2xl rounded-[2rem] border border-white/10 bg-black/35 p-6 shadow-2xl backdrop-blur-md xl:p-8">
                <h2 className="text-5xl font-black leading-tight tracking-tight xl:text-6xl">
                  OLIVER
                  <br />
                  <span className="bg-gradient-to-r from-[#b8860b] via-[#d4af37] to-[#f7d56b] bg-clip-text text-transparent">
                    ERP
                  </span>
                </h2>
        ...
        <section className="flex items-center justify-center bg-gradient-to-br from-[#f7f7f7] via-white to-[#eaeaea] p-5">
          <div className="w-full max-w-xl rounded-[2rem] border border-[#d4af37]/25 bg-white p-8 shadow-2xl shadow-slate-300/60 sm:p-10">
            <div className="mb-10 text-center">
              <div className="mx-auto mb-6 flex min-h-28 w-full items-center justify-center rounded-[2rem] border border-[#d4af37]/30 bg-gradient-to-br from-[#111111] via-[#1a1a1a] to-[#2b2b2b] p-4 shadow-lg">
                {config.logoEmpresa ? (
                  <img
                    src={config.logoEmpresa}
                    alt={config.nome || "OLIVER ERP"}
